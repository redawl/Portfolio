...
content = {
    ...
    projects: () => {
        ...
        $('#VFG')
        .append('<h4>Vector Field Generator</h4>' + 
        ...
        $('#HTTP')
        .append('<h4>Simple HTTPServer</h4>' +
                    ...
                    '<p>I learned a lot while working on this project, such as '
        )
    },
    resume: () => {
        $('#content').empty().css({display : ""})
        .append('<div class="card p-5 mt-3"><embed src="eliburch2021.pdf" type="application/pdf" width="100%" height="600px" /></div>');
    },
    contact: () => { 
        $('#content').empty().css({display : ""})
